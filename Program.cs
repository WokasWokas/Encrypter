...
namespace Encrypter
{
    ...
    class Encrypter
    {
        ...
        public string Encrypt(string message)
        {
            ...
            if (SplitMessage(Blocks.LastOrDefault(), 1).Count == 1)
            ...
            try
            {
                foreach (string Block in Blocks)
                {
                    ...
                    EncryptedBlocks.Add(MultiSquare(IntegerMessage, Exponent) % PublicKey);
                }
        ...
        public string Decode(string message)
        {
            ...
            try
            {
                foreach (string Block in Blocks)
                {
                    ...
                    var IntegerMessage = MultiSquare(block, PrivateKey) % PublicKey;
